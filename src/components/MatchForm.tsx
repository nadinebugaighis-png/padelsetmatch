...
export function MatchForm({ initial, submitLabel, onSubmit, saving, title }: Props) {
  ...
  return (
    <div className="max-w-md sm:max-w-2xl lg:max-w-3xl mx-auto px-5 py-6 pb-36 space-y-6">
      ...
      {/* Sticky submit */}
      <div className="fixed left-0 right-0 px-5 z-30 pointer-events-none [--nav-gap:5.5rem] md:[--nav-gap:1.5rem]" style={{ bottom: "calc(env(safe-area-inset-bottom, 0px) + var(--nav-gap))" }}>
