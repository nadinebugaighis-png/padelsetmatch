...
const en: Dict = {
  ...
  "land.foot": "Play anywhere. More padel, less planning.",
  "land.preview.chip": "Sneak peek",
  "land.preview.title": "Browse the Home",
  "land.preview.sub": "Find the right level and schedule. Sign in to unlock photos, scores and chat.",
...
const es: Dict = {
  ...
  "land.foot": "Juega donde quieras. Más pádel, menos planificación.",
  "land.preview.chip": "Adelanto",
  "land.preview.title": "Echa un vistazo al Inicio",
  "land.preview.sub": "Encuentra el nivel y horario que te encajan. Inicia sesión para ver fotos, puntuaciones y chat.",
