...
const en: Dict = {
  ...
  "land.cta": "Start matching",
  "land.what": "What's Playtomic?",
  "land.stat1": "cities, your call",
  "land.stat2": "sport that connects",
  ...
  "prof.private": "Your preferences (who you're looking for, age range, values you care about) are kept private — they're only used by the AI to find your matches, never shown on your profile. Retake the questionnaire any time to update them.",
...
const es: Dict = {
  ...
  "land.cta": "Empezar a hacer match",
  "land.what": "¿Qué es Playtomic?",
  "land.stat1": "ciudades, tú decides",
  "land.stat2": "deporte que une",
  ...
  "prof.private": "Tus preferencias (a quién buscas, rango de edad, valores que te importan) son privadas — solo las usa la IA para encontrar tus matches, nunca se muestran en tu perfil. Puedes rehacer el cuestionario cuando quieras.",
