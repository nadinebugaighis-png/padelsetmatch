...
export const LOCATION_DATA: CountryData[] = [
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Miami (Broward / Fort Lauderdale)", areas: ["Fort Lauderdale", "Las Olas", "Hollywood", "Weston", "Plantation", "Coral Springs", "Pembroke Pines", "Davie", "Sunrise", "Parkland"] },
      { name: "Palm Beach", areas: ["Palm Beach", "West Palm Beach", "Boca Raton", "Delray Beach", "Jupiter", "Wellington", "Boynton Beach"] },
      { name: "Orlando", areas: ["Downtown", "Winter Park", "Lake Nona", "Dr. Phillips", "Windermere", "Celebration", "Kissimmee"] },
      { name: "Tampa / St. Petersburg", areas: ["Downtown Tampa", "South Tampa", "Hyde Park", "Westchase", "St. Petersburg", "Clearwater", "Wesley Chapel", "Brandon"] },
      { name: "Sarasota", areas: ["Downtown Sarasota", "Siesta Key", "Lakewood Ranch", "Longboat Key", "Bradenton", "Venice"] },
      { name: "Naples / Fort Myers", areas: ["Naples", "Bonita Springs", "Estero", "Fort Myers", "Cape Coral", "Marco Island"] },
      { name: "Jacksonville", areas: ["Downtown", "Jacksonville Beach", "Ponte Vedra", "St. Augustine", "Nocatee"] },
      { name: "Florida Keys", areas: ["Key West", "Key Largo", "Islamorada", "Marathon"] },
      { name: "Florida (other)", areas: ["Gainesville", "Tallahassee", "Pensacola", "Destin", "Ocala", "Vero Beach"] },
