...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PadelMatch — more games, better people" },
      { name: "description", content: "Connect with Padel players nearby you, join games, discover courts, and be the community." },
      { property: "og:site_name", content: "PadelMatch" },
      { property: "og:title", content: "PadelMatch — more games, better people" },
      { property: "og:description", content: "Connect with Padel players nearby you, join games, discover courts, and be the community." },
