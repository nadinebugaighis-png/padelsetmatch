        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-4 sm:gap-5">
            ...
            <StepCard
              ...
              body={tr("When you both tap, a chat opens. Coordinate your match and book a public court on Playtomic — or, if someone has free access to a padel court, arrange the game right there and invite more players to join. You don't have to leave the app.", "Cuando os pulsáis mutuamente, se abre el chat. Coordinad el partido y reservad una pista pública en Playtomic — o, si alguien tiene acceso gratuito a una pista, organizad el partido allí mismo e invitad a más jugadores a unirse. No tienes que salir de la app.", "Quand vous vous tapez tous les deux, un chat s'ouvre. Organise ton match et réserve une pista publique sur Playtomic — ou, si quelqu'un a accès gratuit à une pista, organise la partie directement et invite d'autres joueurs à se joindre. Sans quitter l'app.")}
            />
          </div>
        </div>
      </section>
