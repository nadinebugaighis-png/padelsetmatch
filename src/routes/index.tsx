...
import shareBanner from "@/assets/padel-whatsapp-share.jpg.asset.json";
    ...
    <main className="programme-page min-h-screen flex flex-col relative overflow-hidden">
      ...
      <section className="relative z-10 flex-1 px-5 sm:px-8 lg:px-16 pt-2 lg:pt-0 pb-6 lg:flex lg:flex-col lg:justify-center lg:min-h-[calc(100dvh-64px)]">
        <div className="max-w-xl">
          ...
          <h1 className="text-serif mt-2 lg:mt-1 uppercase text-[var(--ink)] leading-[0.95] tracking-[-0.015em] text-[2.8rem] sm:text-[3.5rem] md:text-[4.25rem] lg:text-[5rem] xl:text-[5.5rem]">
