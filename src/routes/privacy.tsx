...
function Privacy() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-10 text-[var(--court-deep)]/90 space-y-4 bg-[var(--cream)] min-h-screen">
      ...
      <h1 className="text-display text-4xl text-[var(--court-deep)]">Privacy Policy</h1>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">What we collect</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">What we do NOT collect</h2>
      <ul className="list-disc pl-6 space-y-1">
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">Who can see what</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">Where data is stored</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">Cookies</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">Your rights (GDPR)</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">Contact</h2>
      <p>Privacy requests: use the "Make this app better" box on your Profile screen with the word "Privacy" in your message.</p>

      <div className="pt-6 text-sm">
        <Link to="/terms" className="underline text-[var(--clay)]">← Terms of Service</Link>
      </div>
    </main>
  );
}
