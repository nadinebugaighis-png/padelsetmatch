...
function Terms() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-10 text-[var(--court-deep)]/90 space-y-4 bg-[var(--cream)] min-h-screen">
      <Link to="/" className="text-xs uppercase tracking-widest text-[var(--court)]/60 hover:text-[var(--clay)]">← Home</Link>
      <h1 className="text-display text-4xl text-[var(--court-deep)]">Terms of Service</h1>
      <p className="text-sm text-[var(--court)]/60">Last updated: {new Date().toLocaleDateString()}</p>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">1. Who can use PadelMatch</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">2. How you behave</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">3. Off-platform meetings</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">4. Reports, suspensions and bans</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">5. Your content</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">6. No guarantees</h2>
      ...
      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">7. Changes</h2>
      <p>We may update these terms. If we make material changes we'll notify you in the app.</p>

      <h2 className="text-display text-2xl mt-6 text-[var(--court-deep)]">8. Contact</h2>
      ...
      <div className="pt-6 text-sm">
        <Link to="/privacy" className="underline text-[var(--clay)]">Privacy Policy →</Link>
      </div>
    </main>
  );
}
