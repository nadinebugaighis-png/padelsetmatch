...
ALTER TABLE public.matches ADD COLUMN IF NOT EXISTS origin text NOT NULL DEFAULT 'like';

CREATE OR REPLACE FUNCTION public.open_coach_chat(_coach_profile_id uuid)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.open_coach_chat(uuid) TO authenticated;
